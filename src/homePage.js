        ...
        <div className="homepage">
            ...
            <header className="header">
                ...
                <nav className="navbar">
                    <ul className="navList">
                        <li><a href="#cardapio" className="navLink"> Cardápio</a></li>
                        <li><a href="#reservas" className="navLink"> Reservas</a></li>
                        <li><a href="#pedidos" className="navLink"> Pedidos</a></li>
                        <li><a href="#avaliacoes" className="navLink"> Avaliações</a></li>
                    </ul>
                </nav>
            </header>
            ...
            <section id="pedidos" className="sec-pedidos">
                ...
                <div className="pedido-btns">
                    ...
                    <button className="btn-peido">Entrega</button>
                </div>
